...
- ❌ **Fragmented Material Slots**: Duplicate materials across eyes, eyelashes, teeth, and body cause excessive draw calls in Unreal Engine.
...
- *What it does*:
  ...
  - Splits head mesh (`SKM_Head_Mesh`) and body mesh (`SKM_Body_Mesh`).
